  ...
  <div class="notification bg-green-50 border border-green-200 rounded-xl shadow-hard p-4 w-80">
    <div class="flex items-start">
      ...
      <div class="ml-3">
        ...
        <p class="text-xs text-green-600 mt-1">Customer details have been successfully updated.</p>
      </div>
    </div>
  </div>
</div>
  ...
  <div class="notification bg-red-50 border border-red-200 rounded-xl shadow-hard p-4 w-80">
    <div class="flex items-start">
      ...
      <div class="ml-3">
        ...
        <p class="text-xs text-red-600 mt-1">Failed to update customer details. Please try again.</p>
      </div>
    </div>
  </div>
</div>
    ...
    <div class="flex items-center justify-between">
      <div>
        <div class="flex items-center">
          ...
          <div>
            <h1 class="text-2xl font-bold tracking-tight">Edit Customer Details</h1>
            <p class="text-primary-100 opacity-90 mt-1 text-sm">Account: <%= accountNumber %></p>
          </div>
        </div>
      </div>
  ...
  <div class="p-8">
    <form action="update-customer" method="post" class="space-y-6">
      ...
      <div class="flex flex-col-reverse md:flex-row justify-between pt-6 gap-4">
        <div>
          <a href="viewAccounts.jsp" class="btn inline-flex items-center justify-center px-6 py-3 border border-gray-300 text-sm font-medium rounded-lg shadow-sm text-gray-700 bg-white hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-primary-500">
            <i class="fas fa-arrow-left mr-2"></i>
            Back to Customers
          </a>
        </div>
        <div class="flex gap-4">
          <button type="reset" class="btn inline-flex items-center justify-center px-6 py-3 border border-gray-300 text-sm font-medium rounded-lg shadow-sm text-gray-700 bg-white hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-primary-500">
